...
你需要按照项目推荐的 [开发流程](./how-to-develop) 发布一个版本，[CI](/.github/workflows/install.yml) 会自动完成打包工作。具体的工作方式请参考 [GitHub Actions 文档](https://docs.github.com/zh/actions)。
...
::: warning
在提问前，请完整阅读 [MaaFramework 开发文档](https://maafw.com/docs/1.1-QuickStarted) 以及 [如何开发](./how-to-develop)，通常情况下它们能解决大多数问题。
